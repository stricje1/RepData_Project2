...
Next, we deal with injuries caused by severe whether events. We present the effects of weather events with respect to fatalities the horizontal barplot shown in Figure 2.
...
Table 6 Summarizes the injury results visually.
...
### *Propery Damage*
As we did with public health effects, we generate Table 7 with the property damage resulting from severe weather, with an accompanying top horizontal barchart in Figure 3.
